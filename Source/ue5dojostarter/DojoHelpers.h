// Generated by dojo-bindgen on Tue, 25 Mar 2025 13:46:16 +0000. Do not modify this file manually.
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Calls")
    void CallDojoStarterActionsMove(const FAccount& account, EDDirection direction);

    UFUNCTION(BlueprintCallable, Category = "Controller Calls")
    void CallControllerDojoStarterActionsMove(const FControllerAccount& account, EDDirection direction);
